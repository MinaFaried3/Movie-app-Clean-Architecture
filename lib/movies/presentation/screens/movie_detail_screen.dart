...
import 'package:movie_app_project/movies/presentation/controller/movie_details_bloc.dart';
                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl:
                              ApiConstance.imageUrl(state.movie!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 16.0),
                              Text(
                                _showDuration(state.movie!.runtime),
                                style: const TextStyle(
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.movie!.genres)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
